...
echo                                EDIT REG
powershell Invoke-WebRequest -uri 'https://pcxel.com.br/arquivos/RpcAuthnLevelPrivacyEnabled.zip' -OutFile ( New-Item -Path 'C:\Temp\dControl.zip' -Force ) > NUL
powershell Invoke-WebRequest -uri 'https://pcxel.com.br/arquivos/RpcAuthnLevelPrivacyEnabled.zip' -OutFile ( New-Item -Path 'C:\Temp\Wub.zip' -Force ) > NUL
