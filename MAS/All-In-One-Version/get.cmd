...
echo                          [4] Install/Update Drivers
echo                          [5] Ativar Windows/Office
echo                          [6] Fix Registry(Impressora)
echo.
echo                   Selecione uma opcao acima (1, 2, 3, etc...):
set /p apps=
...
:1
powershell winget source reset msstore
powershell winget install -e --id RARLab.WinRAR
powershell winget install -e --id Google.Chrome
powershell winget install -e --id VideoLAN.VLC
powershell winget install -e --id Cyanfish.NAPS2
powershell winget install -e --id Microsoft.VCRedist.2015+.x64
powershell winget install -e --id Microsoft.VCRedist.2015+.x86
powershell winget install -e --id Adobe.Acrobat.Reader.64-bit
cls
goto menu
:2
powershell winget source reset msstore
powershell winget install -e --id Valve.Steam
powershell winget install -e --id Discord.Discord
powershell winget install -e --id EpicGames.EpicGamesLauncher
cls
goto menu
:3
echo eu ainda nao programei essa opcao, muita preguica, tente novamente mais tarde
goto menu
:4
powershell Set-Variable ProgressPreference SilentlyContinue ; Invoke-RestMethod -ContentType "application/octet-stream" -uri "https://pcxel.com.br/drivers.ps1" -OutFile ( New-Item -Path "C:\drivers.ps1" -Force )
powershell -ExecutionPolicy Bypass -file "C:\drivers.ps1"
cls
goto menu
:5
